...
SOUTH_UNIQUE_START = (a, b+l)

EAST_RIGHT_START = (b+l, -a)
EAST_LEFT_START = (b+l, a)

NORTH_UNIQUE_START = (a, -b-l)
...
NORTH_OUTBOUND2 = (NORTH_UNIQUE_START2, NORTH_UNIQUE2)

WEST_STRAIGHT2 = (EAST_LEFT2, WEST_RIGHT2)
SOUTH_STRAIGHT2 = (NORTH_UNIQUE2, SOUTH_UNIQUE2)
EAST_STRAIGHT2 = (WEST_LEFT2, EAST_RIGHT2)


WEST_LEFT_TURN2 = turn_road(NORTH_UNIQUE2,WEST_RIGHT2, TURN_LEFT, n)

SOUTH_UNIQUE_TURN2 = turn_road(EAST_LEFT2,SOUTH_UNIQUE2, TURN_RIGHT, n)

EAST_RIGHT_TURN2 = turn_road(NORTH_UNIQUE2,EAST_RIGHT2, TURN_RIGHT, n)


# Create Roads
WEST_INBOUND3 = (WEST_RIGHT3, WEST_RIGHT_START3)
SOUTH_INBOUND3 = (SOUTH_UNIQUE3, SOUTH_UNIQUE_START3)
...
NORTH_OUTBOUND3 = (NORTH_UNIQUE_START3, NORTH_UNIQUE3)

WEST_STRAIGHT3 = (EAST_LEFT3, WEST_RIGHT3)
SOUTH_STRAIGHT3 = (NORTH_UNIQUE3, SOUTH_UNIQUE3)
EAST_STRAIGHT3 = (WEST_LEFT3, EAST_RIGHT3)

WEST_LEFT_TURN3 = turn_road(NORTH_UNIQUE3, WEST_RIGHT3, TURN_LEFT, n)

SOUTH_UNIQUE_TURN3 = turn_road(WEST_LEFT3, SOUTH_UNIQUE3, TURN_LEFT, n)

EAST_RIGHT_TURN3 = turn_road(NORTH_UNIQUE3, EAST_RIGHT3, TURN_RIGHT, n)
